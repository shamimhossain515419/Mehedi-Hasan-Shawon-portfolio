     ...
     return (
          <div>
               ...
               <div className=' space-y-3 flex   flex-col '>
                    ...
                    <NavLink  className={({isActive})=> isActive ? `  text-white   border-b-2 border-[#FF014F] text-lg font-semibold   uppercase ` : ` text-[#c1b9b9]  text-lg font-semibold   uppercase` } to={'/services'}> Services</NavLink>
