          ...
          <div className="  my-20">
               <div className="grid  items-center md:grid-cols-2 gap-5 ">
                    <div className=" boxshawdow aboutimg  rounded-xl  p-6 md:p-10 relative overflow-hidden ">
                         <img className=" h-[500px] 4 object-cover w-full  " src="https://i.ibb.co/1s108dX/Picsart-23-05-15-12-25-41-791.jpg" alt="" />
                    </div>
                    <div className=" p-4 md:max-w-[600px]">
                         <p className=" text-2xl font-medium  textColor my-2"> VISIT MY PORTFOLIO & HIRE ME</p>
